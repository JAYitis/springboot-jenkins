        ...
        stage('build') {
            ...
            steps {
                script{
                    ...
                    sh "docker build -t jay1011/springboot-jenkins:${IMAGE_NAME} ."
        ...
        input{
            ...
            steps {
                ...
                withCredentials([usernamePassword(credentialsId: 'docker', usernameVariable: 'USERNAME', passwordVariable: 'PASSWORD')]){
                    ...
                    sh "docker push jay1011/springboot-jenkin:${IMAGE_NAME}"
                }}
...
//                         sh "git remote set-url origin https://${USERNAME}:${PASSWORD}@github.com/JAYitis/springboot-jenkins.git"
//                         sh 'git add .'
